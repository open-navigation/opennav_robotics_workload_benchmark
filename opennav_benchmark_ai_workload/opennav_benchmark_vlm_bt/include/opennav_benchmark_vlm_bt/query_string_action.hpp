...
#ifndef OPENNAV_BENCHMARK_VLM_BT__QUERY_STRING_ACTION_HPP_
#define OPENNAV_BENCHMARK_VLM_BT__QUERY_STRING_ACTION_HPP_

#include <string>

#include "opennav_benchmark_vlm_msgs/action/query_string.hpp"
 ...
 * action server and returns a string result. Returns SUCCESS if the VLM
 * query succeeded, FAILURE otherwise. The string answer is available
 * via the "value" output port.
 */
class QueryStringAction
  : public nav2_behavior_tree::BtActionNode<opennav_benchmark_vlm_msgs::action::QueryString>
{
    ...
    return providedBasicPorts(
      {
        ...
        BT::OutputPort<std::string>("value", "String result from VLM"),
...
#endif  // OPENNAV_BENCHMARK_VLM_BT__QUERY_STRING_ACTION_HPP_
