...
CancelQueryString::CancelQueryString(
  const std::string & xml_tag_name,
  const std::string & action_name,
  const BT::NodeConfiguration & conf)
: BtCancelActionNode<opennav_benchmark_vlm_msgs::action::QueryString>(
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder<opennav_benchmark_vlm_bt::CancelQueryString>(
