...
QueryIntAction::QueryIntAction(
  const std::string & xml_tag_name,
  const std::string & action_name,
  const BT::NodeConfiguration & conf)
: BtActionNode<opennav_benchmark_vlm_msgs::action::QueryInt>(xml_tag_name, action_name, conf)
{
}

void QueryIntAction::on_tick()
{
...
BT::NodeStatus QueryIntAction::on_success()
{
...
BT::NodeStatus QueryIntAction::on_aborted()
{
  return BT::NodeStatus::FAILURE;
}

BT::NodeStatus QueryIntAction::on_cancelled()
{
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder<opennav_benchmark_vlm_bt::QueryIntAction>("QueryInt", builder);
}
